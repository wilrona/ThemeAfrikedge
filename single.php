...
<?php while (have_posts()) : the_post(); ?>
    ...
    <div style="border-bottom: 1px solid #eee" class="uk-padding uk-background-afrikedge-2">
        <h1 class="uk-h3 uk-color-white uk-margin-remove"><a href="<?= get_the_permalink(tr_options_field('options.page_blog')) ?>" class="uk-link-text uk-color-white">Actualite</a> - <?= get_the_title() ?></h1>
    </div>
                    ...
                    <div class="uk-flex" uk-grid>
                        <div class="uk-width-1-1 uk-margin-medium-bottom uk-flex-last@l">
                            <ul class="uk-nav uk-nav-default">
                                <li class="uk-active"><a href="<?= get_the_permalink(tr_options_field('options.page_blog')) ?>">Retour a l'actualite</a></li>
                            </ul>
                        </div>
